# about old youtube flash players

yt2009 implements endpoints used by flash players for them to work properly.

included players are pre-set to use with yt2009, but if you want to use your own players, the following may be useful for you.

---
## prerequisites
- flash player decompiler: https://github.com/jindrapetrik/jpexs-decompiler/releases
...
---
## important: when testing the modified .swf, use the web address instead of a `file://` address. the latter may experience issues connecting to the internet.
---
...
- taking the modified `watch2.swf` as an example, put it into your yt2009 root directory and navigate to:
